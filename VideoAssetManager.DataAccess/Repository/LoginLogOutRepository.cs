...
{
    public class LoginLogOutRepository : Repository<LoginLogOutMaster>, ILoginLogOutRepository
    {
        private readonly VideoAssetManagerDBContext _VideoAssetManagerDBContext;
        public LoginLogOutRepository(VideoAssetManagerDBContext VideoAssetManagerDBContext) : base(VideoAssetManagerDBContext)
        {
