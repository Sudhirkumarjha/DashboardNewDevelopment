...
{
    public class TabMenuPermissionRepository : Repository<TabMenuPermission>, ITabMenuPermissionRepository
    {
        private readonly VideoAssetManagerDBContext _VideoAssetManagerDBContext;
        public TabMenuPermissionRepository(VideoAssetManagerDBContext VideoAssetManagerDBContext) : base(VideoAssetManagerDBContext)
        {
