...
{
    public class EditedVideosRepository : Repository<VM_EditedVideos>, IEditedVideosRepository
    {
        private readonly VideoAssetManagerDBContext _VideoAssetManagerDBContext;
        public EditedVideosRepository(VideoAssetManagerDBContext VideoAssetManagerDBContext) : base(VideoAssetManagerDBContext)
        {
