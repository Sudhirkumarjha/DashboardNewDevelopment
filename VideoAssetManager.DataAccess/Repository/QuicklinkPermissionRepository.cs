...
{
    public class QuicklinkPermissionRepository : Repository<QuicklinkPermission>, IQuicklinkPermissionRepository
    {
        private readonly VideoAssetManagerDBContext _VideoAssetManagerDBContext;
        public QuicklinkPermissionRepository(VideoAssetManagerDBContext VideoAssetManagerDBContext) : base(VideoAssetManagerDBContext)
        {
